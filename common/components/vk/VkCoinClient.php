 ...
 */
class VkCoinClient extends Component
{
    ...
    public function generatePayLink(int $sum, int $payload = null, bool $fixed_sum = null, bool $use_hex_link = null)
    {
        ...
        if ($use_hex_link) {
            ...
            $link = "https://vk.com/coin#m{$merchant_id}_{$sum}_{$payload}" . ($fixed_sum ? "" : "_1");
        } else {
            $merchant_id = $this->merchant_id;

            $link = "https://vk.com/coin#x{$merchant_id}_{$sum}_{$payload}" . ($fixed_sum ? "" : "_1");
        }
